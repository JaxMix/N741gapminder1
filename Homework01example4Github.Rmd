...
The standard deviation of the mean life expectancy is `r round(sd(gapminder$lifeExp), digits=2)` years.

The median life expectancy is `r round(median(gapminder$lifeExp), digits=2)` years.

The sample size is n = `r round(length(gapminder$lifeExp), digits=2)` 
